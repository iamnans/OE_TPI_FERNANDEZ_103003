...
# Alumna: Nancy Fernandez

# TPI: Proyecto desarrollado sobre la generación de un CHATBOT para el proceso de solicitud y rendición de un vale de caja.

Descripción: El chatbot fue desarrollado en Python, para automatizar el proceso de solicitud y rendición de vales de caja de una empresa privada, proceso que actualmente
